...
function Skill() {
  const skills = [
    ...
    { language: "Node.js", percentage: 50 },
    { language: "Express.js", percentage: 50 },
    { language: "MongoDB", percentage: 60 },
  ];
  return (
    <>
      <div
      ...
      >
        ...
        <div className="text-center my-10 hover:scale-105 duration-200">
          <a
            href=""
            className="border px-4 py-2 rounded-md text-gray-300 bg-yellow-600  "
          >
            {" "}
            Download CV
          </a>
